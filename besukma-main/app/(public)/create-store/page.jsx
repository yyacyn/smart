            ...
            if(['approved', 'pending', 'rejected'].includes(data.status)){
                ...
                switch(data.status){
                    case "approved":
                        ...
                        break;
                    case "rejected":
                        setMessage("Your store has been rejected. Please contact admin for more information.");
                        break;
                    case "pending":
                        setMessage("Your store is currently under review. You will be notified once it's approved.");
                        break;
                    default:
                        break;
                }
